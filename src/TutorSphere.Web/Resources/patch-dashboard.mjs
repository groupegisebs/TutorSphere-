...
const KEYS = {
  TutorDashboard_RevenueHint: {
    fr: "Les revenus du mois s'affichent ci-dessus à partir des données de votre école.",
    en: "Monthly revenue is shown above from your school's data.",
  },
  TutorDashboard_NoUpcomingLessons: {
    fr: "Aucun cours à venir.",
    en: "No upcoming lessons.",
  },
  TutorDashboard_NoRecentActivity: {
