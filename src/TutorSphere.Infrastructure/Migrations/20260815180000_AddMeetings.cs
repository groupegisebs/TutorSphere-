...
namespace TutorSphere.Infrastructure.Migrations
{
    ...
    [Migration("20260815180000_AddMeetings")]
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MeetingParticipantsSet_MeetingExternalGuestsSet_ExternalGuestId",
            ...
            migrationBuilder.CreateIndex(name: "IX_MeetingsSet_OrganizerUserId", table: "MeetingsSet", column: "OrganizerUserId");
            migrationBuilder.CreateIndex(name: "IX_MeetingsSet_OrganizerGroupId", table: "MeetingsSet", column: "OrganizerGroupId");
            migrationBuilder.CreateIndex(name: "IX_MeetingsSet_Status", table: "MeetingsSet", column: "Status");
            migrationBuilder.CreateIndex(name: "IX_MeetingsSet_StartAtUtc", table: "MeetingsSet", column: "StartAtUtc");
            migrationBuilder.CreateIndex(name: "IX_MeetingRecurrencesSet_MeetingId", table: "MeetingRecurrencesSet", column: "MeetingId", unique: true);
            migrationBuilder.CreateIndex(
                name: "IX_MeetingGroupsSet_MeetingId_ExpertGroupId",
                table: "MeetingGroupsSet",
                columns: new[] { "MeetingId", "ExpertGroupId" },
                unique: true);
            migrationBuilder.CreateIndex(name: "IX_MeetingGroupsSet_ExpertGroupId", table: "MeetingGroupsSet", column: "ExpertGroupId");
            migrationBuilder.CreateIndex(name: "IX_MeetingExternalGuestsSet_TokenHash", table: "MeetingExternalGuestsSet", column: "TokenHash");
            migrationBuilder.CreateIndex(name: "IX_MeetingExternalGuestsSet_MeetingId", table: "MeetingExternalGuestsSet", column: "MeetingId");
            migrationBuilder.CreateIndex(name: "IX_MeetingParticipantsSet_MeetingId", table: "MeetingParticipantsSet", column: "MeetingId");
            migrationBuilder.CreateIndex(name: "IX_MeetingParticipantsSet_MeetingId_UserId", table: "MeetingParticipantsSet", columns: new[] { "MeetingId", "UserId" });
            migrationBuilder.CreateIndex(name: "IX_MeetingParticipantsSet_ExternalGuestId", table: "MeetingParticipantsSet", column: "ExternalGuestId");
            migrationBuilder.CreateIndex(name: "IX_MeetingInvitationsSet_MeetingId", table: "MeetingInvitationsSet", column: "MeetingId");
            migrationBuilder.CreateIndex(name: "IX_MeetingSessionsSet_MeetingId", table: "MeetingSessionsSet", column: "MeetingId");
            migrationBuilder.CreateIndex(name: "IX_MeetingAttendancesSet_SessionId", table: "MeetingAttendancesSet", column: "SessionId");
            migrationBuilder.CreateIndex(name: "IX_MeetingAttendancesSet_ParticipantId", table: "MeetingAttendancesSet", column: "ParticipantId");
            migrationBuilder.CreateIndex(name: "IX_MeetingMessagesSet_SessionId", table: "MeetingMessagesSet", column: "SessionId");
            migrationBuilder.CreateIndex(name: "IX_MeetingFilesSet_MeetingId", table: "MeetingFilesSet", column: "MeetingId");
            migrationBuilder.CreateIndex(name: "IX_MeetingRecordingsSet_MeetingId", table: "MeetingRecordingsSet", column: "MeetingId");
            migrationBuilder.CreateIndex(name: "IX_MeetingTranscriptsSet_MeetingId", table: "MeetingTranscriptsSet", column: "MeetingId");
            migrationBuilder.CreateIndex(
                name: "IX_MeetingAiConsentsSet_MeetingId_SubjectKey",
                table: "MeetingAiConsentsSet",
                columns: new[] { "MeetingId", "SubjectKey" },
                unique: true);
            migrationBuilder.CreateIndex(name: "IX_MeetingAiSummariesSet_MeetingId", table: "MeetingAiSummariesSet", column: "MeetingId");
            migrationBuilder.CreateIndex(name: "IX_MeetingDecisionsSet_MeetingId", table: "MeetingDecisionsSet", column: "MeetingId");
            migrationBuilder.CreateIndex(name: "IX_MeetingActionItemsSet_MeetingId", table: "MeetingActionItemsSet", column: "MeetingId");
            migrationBuilder.CreateIndex(name: "IX_MeetingNotificationsSet_MeetingId", table: "MeetingNotificationsSet", column: "MeetingId");
            migrationBuilder.CreateIndex(name: "IX_MeetingAuditLogsSet_MeetingId", table: "MeetingAuditLogsSet", column: "MeetingId");
        }

        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DropTable(name: "MeetingAuditLogsSet");
            migrationBuilder.DropTable(name: "MeetingNotificationsSet");
            migrationBuilder.DropTable(name: "MeetingActionItemsSet");
            migrationBuilder.DropTable(name: "MeetingDecisionsSet");
            migrationBuilder.DropTable(name: "MeetingAiSummariesSet");
            migrationBuilder.DropTable(name: "MeetingAiConsentsSet");
            migrationBuilder.DropTable(name: "MeetingTranscriptsSet");
            migrationBuilder.DropTable(name: "MeetingRecordingsSet");
            migrationBuilder.DropTable(name: "MeetingFilesSet");
            migrationBuilder.DropTable(name: "MeetingMessagesSet");
            migrationBuilder.DropTable(name: "MeetingAttendancesSet");
            migrationBuilder.DropTable(name: "MeetingSessionsSet");
            migrationBuilder.DropTable(name: "MeetingInvitationsSet");
            migrationBuilder.DropTable(name: "MeetingParticipantsSet");
            migrationBuilder.DropTable(name: "MeetingExternalGuestsSet");
            migrationBuilder.DropTable(name: "MeetingGroupsSet");
            migrationBuilder.DropTable(name: "MeetingRecurrencesSet");
            migrationBuilder.DropTable(name: "MeetingsSet");
        }
    }
}
