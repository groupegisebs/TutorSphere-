...
public static partial class TeacherContractCatalog
{
    ...
    public static TeacherContractWorkspaceChrome WorkspaceChrome(string language) =>
        SupportedLanguageCodes.Normalize(language) switch
        {
            SupportedLanguageCodes.English => new(
                "My contracts",
                "Review and download your collaboration contracts. Signed documents cannot be changed.",
                "Action required. You have a contract waiting for signature.",
                "Open contract",
                "No contracts yet.",
                "No.",
                "Group",
            ...
            SupportedLanguageCodes.Spanish => new(
                "Mis contratos",
                "Consulte y descargue sus contratos de colaboración. Los documentos firmados no se pueden modificar.",
                "Acción requerida. Tiene un contrato pendiente de firma.",
                "Abrir el contrato",
            ...
            SupportedLanguageCodes.German => new(
                "Meine Verträge",
                "Sehen Sie Ihre Kooperationsverträge ein und laden Sie sie herunter. Unterzeichnete Dokumente können nicht geändert werden.",
                "Handlung erforderlich. Sie haben einen Vertrag, der auf die Unterschrift wartet.",
                "Vertrag öffnen",
                "Noch keine Verträge.",
                "Nr.",
                "Gruppe",
                ...
                "Schließen",
                "Fingerabdruck",
                "Unterschrift fortsetzen"),
            SupportedLanguageCodes.Portuguese => new(
                "Os meus contratos",
                "Consulte e descarregue os seus contratos de colaboração. Os documentos assinados não podem ser alterados.",
                "Ação necessária. Tem um contrato a aguardar assinatura.",
                "Abrir o contrato",
            ...
            SupportedLanguageCodes.Arabic => new(
                "عقودي",
                "اطّلع على عقود التعاون وحمّلها. لا يمكن تعديل المستندات الموقَّعة.",
                "إجراء مطلوب. لديك عقد بانتظار التوقيع.",
                "فتح العقد",
                "لا توجد عقود بعد.",
                "الرقم",
                "المجموعة",
            ...
            _ => new(
                "Mes contrats",
                "Consultez et téléchargez vos contrats de collaboration. Les documents signés ne sont pas modifiables.",
                "Action requise. Vous avez un contrat en attente de signature.",
                "Ouvrir le contrat",
                ...
                "Fermer",
                "Empreinte",
                "Continuer la signature")
        };
}

public sealed record TeacherContractWorkspaceChrome(
    string Title,
    string Subtitle,
