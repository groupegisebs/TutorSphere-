...
EMAIL_BASE_URL="${EMAIL_BASE_URL:-https://gisemailsender.gisebs.com}" \
API_BASE_URL="${API_BASE_URL}" \
API_PORT="${API_PORT}" \
WEB_PORT="${WEB_PORT}" \
SEED_BOOTSTRAP_ADMIN_ENABLED="${SEED_BOOTSTRAP_ADMIN_ENABLED:-false}" \
SEED_BOOTSTRAP_ADMIN_EMAIL="${SEED_BOOTSTRAP_ADMIN_EMAIL:-}" \
SEED_BOOTSTRAP_ADMIN_PASSWORD="${SEED_BOOTSTRAP_ADMIN_PASSWORD:-}" \
SEED_BOOTSTRAP_ADMIN_FIRSTNAME="${SEED_BOOTSTRAP_ADMIN_FIRSTNAME:-Admin}" \
SEED_BOOTSTRAP_ADMIN_LASTNAME="${SEED_BOOTSTRAP_ADMIN_LASTNAME:-Platform}" \
